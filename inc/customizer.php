...
function bootstrap_ag_customize( $wp_customize ) {
 ...
 */
	...
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'header_logo', array(
		'label'       => __('Upload Header Logo', 'bootstrap-ag'),
		'description' => __('Height: &gt;80px', 'bootstrap-ag'),
	...
	$wp_customize->add_control( 'navbar_scheme', array(
		'type'          => 'radio',
		'label'         => __( 'Navbar Scheme', 'bootstrap-ag' ),
		'section'       => 'theme_header_section',
		'choices' => array(
			'default'   => __( 'Default', 'bootstrap-ag' ),
			'inverse'   => __( 'Inverse', 'bootstrap-ag' )
		),
	...
	$wp_customize->add_control( 'navbar_position', array(
		'type'          => 'radio',
		'label'         => __( 'Navbar', 'bootstrap-ag' ),
		'section'       => 'theme_header_section',
		'choices' => array(
			'static'       => __( 'Static', 'bootstrap-ag' ),
			'fixed_top'    => __( 'Fixed to top', 'bootstrap-ag' ),
			'fixed_bottom' => __( 'Fixed to bottom', 'bootstrap-ag' )
		),
	...
	$wp_customize->add_control( 'search_enabled', array(
		'type'          => 'checkbox',
		'label'         => __( 'Show Searchfield?', 'bootstrap-ag' ),
		'section'       => 'theme_header_section',
...
add_action( 'customize_register', 'bootstrap_ag_customize' );


/**
 * Bind JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function bootstrap_ag_customize_preview_js() {
	wp_enqueue_script( 'customizer', get_template_directory_uri() . '/inc/customizer.js', array( 'jquery' ), null, true );
}
add_action( 'customize_preview_init', 'bootstrap_ag_customize_preview_js' );
