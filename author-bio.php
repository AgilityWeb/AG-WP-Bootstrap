	...
	<div class="author-info<?php if ( !is_single() ) : ?> well<?php endif; ?>">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12 author-avatar text-center">
				<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'bootstrap_ag_author_bio_avatar_size', 128 ) ); ?>
			</div><!-- /.author-avatar -->
			<div class="col-lg-9 col-md-9 col-sm-12 author-description">
				<h2><?php printf( __( 'About %s', 'bootstrap-ag' ), get_the_author() ); ?></h2>
				<p><?php the_author_meta( 'description' ); ?></p>
				<p class="author-links">
					<?php
						if ( !empty(get_the_author_meta('user_url')) ) :
							printf( '<a href="%s" class="www btn btn-default btn-sm">' . __('Website', 'bootstrap-ag' ) . '</a>', esc_url( get_the_author_meta( 'user_url' ) ) );
						endif;
					?>
					<?php
